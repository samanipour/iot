...
unsigned long myChannelNumber = 3084723;
const char * myWriteAPIKey = "WFUNNLAWFZY1A2OC";

const char* mqtt_server = "mqtt.thingsboard.cloud";
const int mqtt_port = 1883;
const char* accessToken = "56oli2ZWD7QOLIDtK2cf";
...
void ThingsBoard_setup() {
  ...
  while (!mqttClient.connected()) {
    if (mqttClient.connect("ESP8266_Device", accessToken, NULL)) {
...
void setup() {
  ...
  if (!Connection_setup("Mehdia34", "1382801@mma")) {
